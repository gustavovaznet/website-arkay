...
const services = [
    {
        ...
        link: '#',
        description: 'Traçamos um planejamento e fazemos uma análise profunda do negócio em si, sempre tendo em mente atender todas as necessidades dos clientes.',
        icon: 'fa-plus'
    },
    {
        id: 2,
        title: "Consultoria",
        link: '#',
        description: 'Prestamos consultoria para fazer com que o seu negócio atinja todos os objetivos necessários para um crescimento saudável.',
        icon: 'fa-plus'
    }, {
        id: 3,
        title: "Growing Business",
        link: '#',
        description: 'Trabalhamos duro para conseguirmos um crescimento saudável e constante para o seu negócio de forma segura e sustentável.',
        icon: 'fa-plus'
    }, {
        id: 4,
        title: "Finanças Corporativas",
        link: '#',
        description: 'A saúde financeira do seu negócio é de extrema importância, visando uma excelente saúde financeira traçamos todo um planejamento que involve as finanças como um todo.',
        icon: 'fa-plus'
    }, {
        id: 5,
        title: "Criação de Novos Negócios",
        link: '#',
        description: 'O empreededorismo é uma palavra que está no nosso DNA desde quando passamos a existir uma década atrás, podemos ajudar você a abrir seu próprio negócio de forma simples e com segurança.',
        icon: 'fa-plus'
    }, {
        id: 6,
        title: "Parcerias",
        link: '#',
        description: 'Possuímos diversas empresas parceiras que ajudam nossos clientes sejam formando noivas parcerias ou seja adquirindo produtos e serviços dos mesmos.',
        icon: 'fa-plus'
    }
];
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-12 text-center">
                        <div className="sub-title-2"><span>Serviços</span></div>
